      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        <nav style={{ maxWidth: '1400px', margin: '0 auto', padding: '1.5rem 2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.25rem' }}>
            <a href="#features" style={{ color: 'rgba(255,255,255,0.65)', textDecoration: 'none', padding: '6px 14px', borderRadius: 7, fontSize: '0.9rem', transition: 'color .15s' }}
               onMouseEnter={e => (e.currentTarget.style.color = 'white')}
               onMouseLeave={e => (e.currentTarget.style.color = 'rgba(255,255,255,0.65)')}>
              Features
            </a>
            <a href="/changelog" style={{ color: 'rgba(255,255,255,0.65)', textDecoration: 'none', padding: '6px 14px', borderRadius: 7, fontSize: '0.9rem', display: 'flex', alignItems: 'center', gap: 5, transition: 'color .15s' }}
               onMouseEnter={e => (e.currentTarget.style.color = 'white')}
               onMouseLeave={e => (e.currentTarget.style.color = 'rgba(255,255,255,0.65)')}>
              📋 Changelog
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '5rem 2rem 4rem', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap', marginBottom: '4rem' }}>
            ...
            <a href="#features" style={{ fontSize: '1.05rem', padding: '0.9rem 2.25rem', textDecoration: 'none', borderRadius: 10, fontWeight: 600, background: 'rgba(255,255,255,0.06)', color: 'rgba(255,255,255,0.8)', border: '1px solid rgba(255,255,255,0.1)' }}>
              Mehr erfahren
            </a>
          </div>
        ...
        <div style={{ maxWidth: '1000px', margin: '0 auto 8rem', padding: '0 2rem' }}>
          <div style={{ background: 'linear-gradient(135deg,rgba(59,130,246,0.1),rgba(139,92,246,0.1),rgba(236,72,153,0.1))', border: '1px solid rgba(139,92,246,0.3)', borderRadius: 24, padding: '3.5rem 2.5rem', textAlign: 'center' }}>
            ...
            <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
              ...
              <a href="/changelog" style={{ fontSize: '1.1rem', padding: '0.9rem 2.5rem', textDecoration: 'none', borderRadius: 10, fontWeight: 600, background: 'rgba(255,255,255,0.06)', color: 'rgba(255,255,255,0.75)', border: '1px solid rgba(255,255,255,0.1)' }}>
                📋 Changelog
              </a>
            </div>
          </div>
