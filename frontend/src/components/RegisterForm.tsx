    ...
    <div style={{ maxWidth: '400px', margin: '100px auto' }}>
      <div className="card">
        ...
        <div style={{ marginBottom: '1.5rem', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
          ...
          {/* FrameSphere SSO – gestylter Button konsistent mit LoginForm */}
          <button
            onClick={() => handleOAuthLogin('framesphere')}
            type="button"
            style={{
              width: '100%',
              display: 'flex',
            ...
            onMouseEnter={e => {
              ...
              (e.currentTarget as HTMLButtonElement).style.borderColor = 'rgba(167,139,250,0.6)';
            }}
            onMouseLeave={e => {
